...
public class RestrictPageTest {
    ...
    public void editRestrictionsForPage() throws Exception {
        GlobalFunctionality functionality = new GlobalFunctionality();
        functionality.navigateToUserSpace();
        functionality.gotoExistingPage(1);
        functionality.restrictPageTo("Only some people can view or edit.");
    }
